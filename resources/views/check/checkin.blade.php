    ...
    <div class="col-md-12 mt-5 mb-4 d-flex justify-content-around">
        <div class="card">
            <div class="card-body">
              ...
              <!-- No Labels Form -->
              <form class="row g-3" method="POST" action="{{ route('check.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="col-md-6">
                ...
                <div class="text-center">
                  ...
                  <button type="submit" class="btn btn-outline-primary">Entered products</button>   
                </div>
              </form>
